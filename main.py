...
loaded_train_set, loaded_valid_set, loaded_test_set = load_dataset('dataset')
input_shape = (1, 2, 512)
train_dataset = ()
valid_dataset = ()
test_dataset = ()
...
if K.image_data_format() == 'channels_first':
    ...
    valid_dataset = loaded_valid_set[0].reshape(len(loaded_valid_set[0]), 1, 2, 512)
    ...
    valid_dataset = loaded_valid_set[0].reshape(len(loaded_valid_set[0]), 2, 512, 1)
